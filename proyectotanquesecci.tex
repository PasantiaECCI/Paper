...
\item Definir los valores para “n” desde 0 hasta 3, hay que tener en cuenta que “n” puede llegar a valer $\infty$, sin embargo, entre mayor sea, más pequeño es el valor del termino y por tanto es despreciable para el resultado final de la ecuación. El valor de “n” también depende del número de derivaciones que pueda llegar a tener una ecuación determinada.
	...
	%x\cdot f^{1}\left( 0\right) =x\cdot f'\left( 0\right) =x\cdot e^{0}=x Segundo término de la serie
	%\end{equation}
	...
	%\dfrac {x^{2}\cdot f^{2}\left( 0\right) }{2}=\dfrac {x^{2}\cdot f''\left( 0\right) }{2}=\dfrac {x^{2}}{2}\cdot e^{0}=\dfrac {x^{2}}{2} Tercer término de la serie
	%\end{equation}
	...
	%\dfrac {x^{3}\cdot f^{3}\left( 0\right) }{6}=\dfrac {x^{3}\cdot f'''\left( 0\right) }{6}=\dfrac {x^{3}}{6}\cdot e^{0}=\dfrac {x^{3}}{6} Cuarto término de la serie
	%\end{equation}
