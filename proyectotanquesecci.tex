...
%Donde el coeficiente ( dωd∆p)↓∆p esta es la pendiente de la tangente a la curva de $\omega$ versus $\Delta p$, medida en la operación punto, y tiene el valor -1/K. Para dejando caer los términos de la segunda y de orden superior en la expansión y el uso de las variables incrementales $\omega$ frente $\Delta p$, obtenemos más la relación lineal de w= -1K∆p. \\
...
%La Figura 10. Muestra un recipiente que recibe líquido a un caudal  ωi(t) y pierde  líquido a través de una válvula que obliga la no linealidad de relación flujo contra presión ωo=kp1-pa. El área de la sección transversal es A y la densidad del líquido es  ρ. \\
%La derivada del modelo no lineal obliga para la presión absoluta ρ1 al fondo del recipiente. Luego desarrollar la versión linealizada que es válida en la vecindad de la operación punto, y encontrar la función de trasferencia relacionado la transformación de la entrada incremental ωi(t) y la presión incremental p1. \\
...
%Tomando la presión p1 como la variable de estado, utilizamos p=1c⌊ωin(t)-ωout(t)⌋, con C (h) sustituida por la constante. C=A/ρg, a escribir \\
...
%Si ωi(s) es originalmente igual a este valor nominal de ωi=6.0 x 10-3m3/s y sufre un 10 % aumento paso a la función, luego ωi(t)= [0.60 x 10-3]U(t)m3s y ωi(s)= [0.60 x 10-3](1s). Tenemos. \\
...
%La constante de tiempo del modelo linealizado es τ=RC , cual se convierte en 
...
%Donde ωi y ∆p=p1- pa debe ser uno de los puntos de la curva de la bomba en la Figura 11 (b), y donde ωo obedece a la relación de flujo no lineal.

\begin{equation}
\end{equation}

%Para determinar el punto de trabajo, nos encontramos con la solución de  ωi=ωo  gráficamente trazando la característica de la válvula  ωo=k√∆p  en la curva de la bomba. Hacer esto dada la Figura 12 (a), en el que el punto de trabajo es la intersección de la curva de la válvula y la curva de la bomba, designado como punto A en la figura, una vez que hemos localizado el punto de operación, podemos trazar la tangente a la curva de la bomba como se muestra en la figura 12 (b) y determinar su pendiente -K gráficamente. \\
...
%Después de esta etapa preliminar, podemos utilizar p1=1C(ωi-ωo) para escribir el modelo desde el sistema como:
